...
def _session():
    """Shared retrying session — see oncolens.http.

    A 1,700-article ingest makes ~3,400 requests here; a transient SSLEOFError killed
    one run outright after 45 minutes with nothing written.
    """
    from ..http import session

    return session("pmc_cloud")
